		...
		<table cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
			...
			<tr height="22">		
				<td colspan='4' style="width:100%;padding: 0px 6px;">
					<input type="hidden" name="from_page" value="/SVUIS/std_classes.php" />
...
<font style='font-size:11px' color=red><center>page in 0.0020120143890381 seconds</center></font></body>
</html>
