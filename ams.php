...
<!-------- header --------------->
      <table cellspacing="0" cellpadding="0" width="772" align="center" border="0">
        ...
        <tr>
          <td><img id="head_06" src="images/ams_exams.gif" width="772" height="98" alt="" /></td> 
        </tr>
        <tr bgcolor="#6f7b79">
...
<!--------//-- news --------------->                <table cellspacing="0" cellpadding="0" width="772" align="center" border="0">
                        <tr>
                                <td valign="top" width="1" background="images/grey_pixel.gif"><img height="1" src="images/grey_pixel.gif" width="1" /></td>
                                <td valign="top">
...
<font style='font-size:11px' color=red><center>page in 0.00064301490783691 seconds</center></font></body>
</html>
