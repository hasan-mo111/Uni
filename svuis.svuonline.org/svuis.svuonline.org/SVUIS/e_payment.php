...
.shamcash table form button {
	...
	<table cellspacing="0" cellpadding="0" width="772" align="center" border="0" name="t1">
			<tr>
				<td valign="top" width="1" background="images/grey_pixel.gif"><img height="1" src="images/grey_pixel.gif" width="1" /></td>
				<td valign="top">
		...
		<table cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
			...
			<tr height="22">		
				<td colspan='4' style="width:100%;padding: 0px 6px;">
					<input type="hidden" name="from_page" value="/SVUIS/e_payment.php" />
...
<table cellspacing="0" cellpadding="0" width="95%" align="center" border="0" style="background-color:#D6DEE6;">
            <tr valign="top">
				...
				<td valign="top" width="98%"><br />
					...
					<div class="smenu" >
						<br/>
						<b><font size="3">Shamcash payments</font></b>
					</div>
					<div><img src="images/space.gif" width="2" height="4" /></div>
					<div class="msg_ok">
					<b><br><br><br><br><font style='font-size:14px' ><center>
							
<br>
انتهى التسجيل على المفاضلة لهذا الفصل
<br><br><br>
<br>
--  شكرا  --
<br>
...
<font style='font-size:11px' color=red><center>page in 0.0017480850219727 seconds</center></font>
