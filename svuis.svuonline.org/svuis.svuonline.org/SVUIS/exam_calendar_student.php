		...
		<table cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
			...
			<tr height="22">		
				<td colspan='4' style="width:100%;padding: 0px 6px;">
					<input type="hidden" name="from_page" value="/SVUIS/exam_calendar_student.php" />
...
<tr><td> &nbsp;  <td></tr>
 ...
 <tr>
 	<td class="gray_padd15" align="left"  class="tdpadding" colspan="2" >	
 		<h1 style="margin: 5px;color: #005a82;font-size: 16px;text-align: center;padding-bottom: 20px;text-shadow: 0px 8px 4px #b1a25f;font-weight: bold;text-decoration: underline;">
		 Exam Time Table
		</h1>
 	</td>
</tr>
...
<tr>		
	<td class="gray_padd15" align="left"><b>Choose A Program</b></td>
	<td class="gray_padd10" align="left">
													...
													<select name="Program" id="Program" type="text" class="input" style="width: 350px">
						<option value='-1'>&raquo;&raquo; Select Program </option>
						<option value='0'>&raquo;&raquo; All Programs </option>
														</select>
...
<tr>		
	<td class="gray_padd15" align="left"><b>Choose A Term</b></td>
	<td class="gray_padd10" align="left">
					<select name="Term" id="Term" type="text" class="input" style="width: 350px">
						<option value='-1'>&raquo;&raquo; Select Term </option>
						<option value='50'>S26</option><option value='49'>F25</option><option value='48'>S25</option><option value='47'>F24</option><option value='46'>S24</option><option value='45'>F23</option><option value='44'>S23</option><option value='43'>F22</option><option value='42'>S22</option><option value='41'>F21</option><option value='40'>S21</option><option value='39'>F20</option><option value='38'>S20</option><option value='37'>F19</option><option value='36'>S19</option><option value='35'>F18</option><option value='34'>S18</option><option value='33'>F17</option><option value='32'>S17</option><option value='31'>F16</option><option value='30'>S16</option><option value='29'>F15</option><option value='28'>S15</option><option value='27'>F14</option><option value='26'>S14</option><option value='25'>F13</option><option value='24'>S13</option><option value='23'>F12</option><option value='22'>S12</option><option value='21'>F11</option><option value='20'>S11</option><option value='19'>F10</option><option value='18'>S10</option><option value='17'>F09</option><option value='16'>S09</option><option value='15'>F08</option><option value='14'>S08</option><option value='13'>F07</option><option value='12'>S07</option><option value='11'>F06</option><option value='10'>S06</option><option value='9'>F05</option><option value='8'>S05</option><option value='7'>SU08</option><option value='3'>F04</option><option value='2'>S04</option><option value='1'>F03</option>					</select>
				</td>	
				
				<td class="gray_padd10" align="left">
						<input type="text" id="StudentID" name="StudentID" value='' hidden>
					</td>	
					<td class="gray_padd10" align="left" class='input'>
						<input type="text" id="StudentTelecenter" name="StudentTelecenter" value='' hidden>
					</td>					
</tr>
<tr>					
...
<tr>
 <td align="center" class="tdpadding" colspan="2"> <button type="submit" id="cclick" style=" font-size: 11px; font-weight: bold; margin-bottom: 10px; "> Get Exam Table </button><td>
</tr>
 
  <tr>
 	<td class="gray_padd15" align="right"  class="tdpadding" colspan="2" >
	 <h1 style=" margin: 5px; "><b>تفاصيل مراكز النفاذ الداخلية على موقع الجامعة  </b><a target="_blank" href="https://svuonline.org/ar/%D9%85%D8%B1%D8%A7%D9%83%D8%B2-%D8%A7%D9%84%D9%86%D9%81%D8%A7%D8%B0/%D8%AF%D8%A7%D8%AE%D9%84%D9%8A%D8%A9"> اضغط هنا </a></h1>
 	</td>
 </tr>
 
 <tr>
 	<td class="gray_padd15" align="right"  class="tdpadding" colspan="2" >	
	 <h1 style=" margin: 5px; "><b>تفاصيل مراكز النفاذ  الخارجية على موقع الجامعة  </b><a target="_blank" href="https://svuonline.org/ar/%D9%85%D8%B1%D8%A7%D9%83%D8%B2-%D8%A7%D9%84%D9%86%D9%81%D8%A7%D8%B0/%D8%AE%D8%A7%D8%B1%D8%AC%D9%8A%D8%A9"> اضغط هنا </a></h1>
 	</td>
 </tr>
 ...
 <div id="tel"   align="center"  style="padding:5px 0px 0px 1px;"   >
 <br>
 <br>
						<a href='https://svuonline.org/ar/%D9%85%D8%B1%D8%A7%D9%83%D8%B2-%D8%A7%D9%84%D9%86%D9%81%D8%A7%D8%B0/%D8%AF%D8%A7%D8%AE%D9%84%D9%8A%D8%A9'> <font size="4">  رابط معلومات مراكز النفاذ الداخلية  </a>
						<br>
						<br>
						<a href='https://svuonline.org/ar/%D9%85%D8%B1%D8%A7%D9%83%D8%B2-%D8%A7%D9%84%D9%86%D9%81%D8%A7%D8%B0/%D8%AE%D8%A7%D8%B1%D8%AC%D9%8A%D8%A9'> <font size="4"> رابط معلومات مراكز النفاذ الخارجية</a>
...
$("form[id='exam_time_table']").submit(function(e){
	...
	var formData = new FormData($(this)[0]);
		 ...
		 $.ajax({
			   type: "POST",
			   cache: false,	   
			   url: "exam_calendar_student_validation.php",
			   ...
			   beforeSend: function(){ 
					...
					setTimeout(function () {
						$('#cclick').html('Get Report').prop("disabled", false);
					}, 1000);
				},
