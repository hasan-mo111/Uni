		...
		<table cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
			...
			<tr height="22">		
				<td colspan='4' style="width:100%;padding: 0px 6px;">
					<input type="hidden" name="from_page" value="/SVUIS/std_current_average.php" />
...
.hdr_ar_b {
	font-family: "Simplified Arabic", "Courier New";
	font-size: 11px;
	direction: ltr;
	font-weight: bold;
	text-align: center;
...
<font style='font-size:11px' color=red><center>page in 0.0018808841705322 seconds</center></font></body>
</html>
