...
{ alert("التاريخ غير صحيح، يجب أن يكون على الشكل التالي: 'سنة-شهر-يوم' .\n\nمثال : 2010-12-30 or 2010-06-06");
return false;
}
...
{ alert("السنة غير صالحة.\n\nيجب أن تكون بين 1900 و 2099.");
return false;
}
}
return true;
		...
		<table cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
			...
			<tr height="22">		
				<td colspan='4' style="width:100%;padding: 0px 6px;">
					<input type="hidden" name="from_page" value="/SVUIS/course_time_tutor.php" />
...
<table cellspacing="0" cellpadding="0" width="95%" align="center" border="0" style="background-color:#D6DEE6;">
 ...
 <table cellspacing="0" cellpadding="0" bgcolor="#EFEFEF" width="98%" align="center" border="0" style="border:1px solid #C0C0C0">
					
<!-- --------------------------------------------------------------------------------------------------------------------------- -->
<!-- --------------------------------------------------------------------------------------------------------------------------- -->
<tr><td> &nbsp;  <td></tr>
<tr>		
	<td class="gray_padd15" align="right">Term</td>
			<td class="gray_padd10" align="left">
					<select
						name="Term"
						id="Term" type="text" class="input" style="width: 350px">
						
						<option value='49'>F25</option>					</select>
				</td>	
...
<tr>		
	<td class="gray_padd15" align="right">Program</td>
	<td class="gray_padd10" align="left">
					<select
						name="Program"
						id="Program" type="text" class="input" style="width: 350px" onchange= "GetCourse(this);">
						<option value=-1>&raquo;&raquo; Select Program       </option>
						<option value='82'> | </option><option value='15'>(MBA) | (Master in Business Administration)</option><option value='31'>ACM | ACM Traning program</option><option value='77'>Afaq | Afaq uninersity</option><option value='86'>Afaq_m | Master of afaq</option><option value='30'>AFL | Arabic as a Foreign Language</option><option value='4'>AHND | Arabic Higher National Diploma in Computing and Business Applications</option><option value='44'>ALS | Arabic Learning System</option><option value='34'>ATP | Admission Tests</option><option value='33'>BACT | Bachelor in Communications Technology</option><option value='32'>BAIT | Bachelor in Information Technology</option><option value='25'>BBA | Bachelor in Business Administration</option><option value='65'>BECT | Bachelor of Education (Class teacher)</option><option value='68'>BIMM | Master in Building Information Modeling and Management</option><option value='69'>BIS | Master in Bioinformatics</option><option value='8'>BIT | Bachelor in Information Technology</option><option value='26'>BIT_Bridging | BIT Bridging</option><option value='21'>BL | Bachelor of Law</option><option value='76'>BL_R | Bachelor of Law Not accepted</option><option value='27'>BMC | Bachelor in Mass Communication</option><option value='11'>BRIDG | Bridging to UoG</option><option value='14'>BSCE | Bachelor in Economics</option><option value='58'>BSCM | Bachelor in Economics Management</option><option value='71'>BTHM | Bacholur of Tourism Hospitality Management</option><option value='60'>DAC | Digital Arabic Content</option><option value='81'>DL | Diplomatic Institute</option><option value='28'>DP | Doctoral Program</option><option value='3'>EDU | Grduate Diploma in Education</option><option value='42'>EDUC | Graduate Diploma in Education</option><option value='6'>EHND | English Higher National Diploma in Computing and Business Applications</option><option value='7'>ENG | English program</option><option value='29'>Exam | Exam</option><option value='22'>FDOCT | FormaDoct</option><option value='91'>HBIM | Master of Historical Building Information Modeling</option><option value='88'>HRM | Human Resources Management</option><option value='39'>ICDLTP | ICDLTraining Program</option><option value='47'>IMNR | Integrated Management of Natural Resources</option><option value='2'>ISE | Bachelor in Information System Engineering</option><option value='53'>ITE | Information Technology Engineering</option><option value='57'>KPT | Kids Programming Training</option><option value='73'>LFLBIMM | Building Information Modeling and Management</option><option value='45'>LFLDmail | DMAIL Training Program</option><option value='46'>LFLEmployees | Employees Training Program</option><option value='63'>LFLTOT | Training of Trainers</option><option value='55'>LFL_ALS | Arabic Learning System</option><option value='56'>LFL_ELL | English Language Learning </option><option value='66'>LFL_PMP | Project Management Professional</option><option value='51'>LFL_RUSS | Learning Russian</option><option value='70'>MAL | Master in Applied Linguistics</option><option value='19'>MBA | Master in Business Administration</option><option value='79'>MCS | Master In Computer Science</option><option value='67'>MDA | Master of Qualification and Specialty of the Administrative Development</option><option value='87'>MDT | Master in Digital Transformation Management</option><option value='50'>MedE | Master in Medical Education</option><option value='54'>MedE_R | Master in Medical Education R</option><option value='83'>MHA | Master of Health Administration Program</option><option value='49'>MIHL | Master in International Humanitarian Law</option><option value='35'>MiQ | Master in Quality Programme</option><option value='41'>MITE | Master: Integration of technology in education</option><option value='64'>MMA | ministray of development</option><option value='43'>MNE | Medical National Exam</option><option value='84'>MNGO | Master of Management of non-governmental organizations</option><option value='78'>MNT | Master In Networking Technology</option><option value='18'>MQM | Master in Quality Management</option><option value='89'>MSAI | Master in Web Science and Artificial Intelligence</option><option value='17'>MTM | Master in Technology Management-</option><option value='23'>MWS | Master in Web Sciences</option><option value='20'>MWT | Master in Web Technologies</option><option value='40'>NEP | National Exam Program</option><option value='48'>NIST | Networking and Information Security Training Program</option><option value='36'>PMTM | Master in Technology Management</option><option value='5'>PY | Preparatory Year</option><option value='90'>SCES | Bachelor of Smart Cities Engineering and Sustainability</option><option value='59'>TIBA | Technical Institute for Business Administration</option><option value='80'>tiba_r | Tiba NOT accepted</option><option value='37'>TIC | Technology Institute for Computer</option><option value='85'>TIEMD | Technical Institute for Engineering Management and Digitizing</option><option value='75'>TITH | Technical Institute for Tourism and Hotel Sciences</option><option value='74'>TPCOFC | Training program for the inspectors of the Central Agency for financial supervision</option><option value='61'>TRE | Training courses for employees</option><option value='38'>TRI | Training Program</option><option value='16'>UOG | University Of Greenwich</option>					</select>
				</td>		
...
<tr>		
	<td class="gray_padd15" align="right">Course</td>
			
				<td class="gray_padd10" align="left">
					<select
						name="Course"
						id="Course" type="text" class="input" style="width: 350px" onchange= "GetCourseResult(this)">
						<option value=-1>&raquo;&raquo; Select Course </option>
...
<tr>		
	<td class="gray_padd15" align="right"> Day</td>
			
				<td class="gray_padd10" align="left">
					<select
						name="SessionDay"
						id="SessionDay" type="text" class="input" style="width: 350px" onchange= "GetTutor(this)">
						<option value=-1>&raquo;&raquo; Select Day </option>
...
<tr>		
	<td class="gray_padd15" align="right">Tutor</td>
			
				<td class="gray_padd10" align="left">
					<select
						name="Tutor"
						id="Tutor" type="text" class="input" style="width: 350px" onchange= "GetResult(this)">
						<option value=-1>&raquo;&raquo; Select Tutor </option>
...
<tr>		
  ...
  <table id="TableResult" width="98%" align="center" border="1" cellspacing="0" cellpadding="0" style="border-collapse:collapse; border:1px solid #D5D5D5"> 
  </table>								
...
<!-- --------------------------------------------------------------------------------------------------------------------------- -->							
						...
						<table cellspacing="0" cellpadding="0" width="100%" border="0">
							<tr>
								<td background="images/dotted_pixel_horizontal.gif" height="6">
									<div align="right"><img height="14"	src="images/dotted_pixel_horizontal.gif" width="3" /></div>
								</td>
							</tr>
						</table>
					</tr>
...
function GetCourse(Select)
{    
	document.getElementById('TableResult').innerHTML="";
	document.getElementById('Course').innerHTML="<option value=-1>&raquo;&raquo; Select Course </option>";
	document.getElementById('Tutor').innerHTML="<option value=-1>&raquo;&raquo; Select Tutor </option>";
	document.getElementById('SessionDay').value= -1;
	if(Select != "")
	{
		var AjaxData = "";
		var SelectedProgram = Select.options[Select.selectedIndex].value;
		var SelectedTerm = document.getElementById("Term").value;
			AjaxData = "act=course&program=" + SelectedProgram + "&term=" + SelectedTerm ;
			//alert(AjaxData);
			$.ajax({
				   type: "POST",
				   async: false,		   
				   ...
				   {   
					 ...
					 //-----------------------
					  AjaxData1 = "act=resultcourse&program=" + SelectedProgram + "&term=" + SelectedTerm + "&course=-1";
						...
						$.ajax({
							   ...
							   success: function(msg){   
								    ...
								    //$("#CourseDiv1").html(msg) ;
								   document.getElementById('TableResult').innerHTML=msg;
...
//-----------------------------------------------------------------------------------------------------------------------
function GetCourseResult(Select)
{    
	document.getElementById('TableResult').innerHTML="";
	if(Select != "") 
	{
		var AjaxData = "";
		var SelectedCourse   = Select.options[Select.selectedIndex].value;
		var SelectedTerm     = document.getElementById("Term").value;
		...
		document.getElementById('Tutor').innerHTML="<option value=-1>&raquo;&raquo; Select Tutor </option>";
			...
			AjaxData = "act=resultcourse&program=" + SelectedProgram + "&term=" + SelectedTerm + "&course=" + SelectedCourse;
			$.ajax({
				   type: "POST",
				   async: false,		   
				   url: "course_time_tutor_ajax.php",
...
//-----------------------------------------------------------------------------------------------------------------------
function GetTutor(Select)
{    
	document.getElementById('TableResult').innerHTML="";
	if(Select != "") 
	{
		var AjaxData = "";
		var SelectedSessionDay   = Select.options[Select.selectedIndex].value;
		var SelectedTerm         = document.getElementById("Term").value;
		var SelectedProgram      = document.getElementById("Program").value;
		var SelectedCourse       = document.getElementById("Course").value;
		document.getElementById('Tutor').innerHTML="<option value=-1>&raquo;&raquo; Select Tutor </option>";

		if (SelectedSessionDay < 0)
		{
		AjaxData = "act=resultcourse&program=" + SelectedProgram + "&term=" + SelectedTerm + "&course=" + SelectedCourse;
		$.ajax({
			   type: "POST",
		...
		AjaxData = "act=tutor&program=" + SelectedProgram + "&term=" + SelectedTerm + "&course=" + SelectedCourse + "&sessionday=" + SelectedSessionDay;
		$.ajax({
			   type: "POST",
			   async: false,		   
			   url: "course_time_tutor_ajax.php",
			   ...
			   success: function(msg){
				   //alert(msg);  
				   document.getElementById('Tutor').innerHTML=msg;
				   
				   //-----------------------
				   var AjaxData1 = "act=resultsessionday&program=" + SelectedProgram + "&term=" + SelectedTerm + "&course=" + SelectedCourse + "&sessionday=" + SelectedSessionDay;
				   $.ajax({
						   type: "POST",
						   async: false,		   
						   url: "course_time_tutor_ajax.php",
...
{    
	...
	{
		var AjaxData = "";
		var SelectedTutor    	= Select.options[Select.selectedIndex].value;
		var SelectedTerm     	= document.getElementById("Term").value;
		var SelectedProgram  	= document.getElementById("Program").value;
		var SelectedCourse   	= document.getElementById("Course").value;
		var SelectedSessionDay  = document.getElementById("SessionDay").value;
		...
		{
			AjaxData = "act=finalresult&program=" + SelectedProgram + "&term=" + SelectedTerm + "&course=" + SelectedCourse + "&sessionday=" + SelectedSessionDay + "&tutor=" + SelectedTutor;
			$.ajax({
				   type: "POST",
				   async: false,		   
				   url: "course_time_tutor_ajax.php",
