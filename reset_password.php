...
<br> 
		...
		<table id="rsTabelForm" cellspacing="0" cellpadding="0" width="772" align="center" border="0" style="border: double;margin: 7px 5px; box-shadow: 0px 2px 20px #191919;padding: 8px 20px;padding-top: 18px">
			<tr>
			...
			<tr id="">
				<td style="width: 50%">
					<h4 align="left">
						Please enter your correct information and choose one of the activation methods to send a password reset link.
					</h4>
				</td>
				<td style="width: 50%">
					<h4 align="right">
						يرجى ادخال معلوماتك الصحيحة  واختيار احد طرق التفعيل لإرسال رابط إعادة تعيين كلمة المرور
					</h4>
				</td>
			</tr>
			<tr>
				<td valign="top" colspan="2">
					<form action="javascript:void(0);Step1()" style="padding: 10px 30px;">
						<table id="info" cellpadding="0" cellspacing="0" bgcolor="#FAFAFA" width="100%" dir="ltr">
							<tr id="Response1">
							</tr>
							<tr>
								<td width="30%" height="30px" style="font-size: 12px; color: #333333; padding-left: 5px;">Student User Name<span style="color: #F00;">*</span>:</td>
								<td width="40%" align="center" class="tdpadding">
									<input id="user_name" title="اسم المستخدم" type="text" class="notnull input_style" onblur=""  />
									<!--   onblur="fncCheckOTP(this.value)" -->
								</td>
								<td width="30%" height="30px" style="font-size: 12px; color: #333333; padding-right: 5px; direction: rtl;">اسم المستخدم للطالب<span style="color: #F00;">*</span>:</td>
							</tr>
							<tr>
								<td width="30%" height="30px" style="font-size: 12px; color: #333333; padding-left: 5px;">National/Passport number<span style="color: #F00;">*</span>:</td>
								<td width="40%" align="center" class="tdpadding">
									<input id="sid" title="الرقم الوطني" type="text" class="notnull input_style" onKeypress="return isNumeric(event);  "/>
								</td>
								<td width="30%" height="30px" style="font-size: 12px; color: #333333; padding-right: 5px; direction: rtl;">الرقم الوطني أو رقم جواز السفر<span style="color: #F00;">*</span>:</td>
							</tr>
							<tr style="display:none" id="trr_otp">
								<td width="30%" height="30px" style="font-size: 12px; color: #c30000; padding-left: 5px;">OTP:</td>
								<td width="40%" align="center" class="tdpadding">
									<input type="password" id="user_otp" onKeypress="return isNumeric(event);" class="notnull input_style"/>
								</td>
								<td width="30%" height="30px" style="font-size: 12px; color: #c30000; padding-right: 5px; direction: rtl;">الرمز المتغير من جهاز OTP:</td>
							</tr>
							...
							<tr>
							<td width="30%" height="30px" style="font-size: 12px; color: #333333; padding-left: 5px;">Enter The Capture<span style="color: #F00;">*</span>:</td>
								<td width="40%" align="" class="tdpadding">
									<div style=" width: 100%; display: flex; ">
										<div style=" width: 45%; flex: 1;">
											<img id="secImageURL" src="CaptchaSecurityImages.php"/>
										</div>
										<div style=" width: 45%; flex: 1;">
											<input type="text" id="securityImage" name="securityImage" class="notnull input_style" style="width: 100% !important;    margin-top: 7px; "></input>
										</div>
									</div>
										
								</td>
								<td width="30%" height="30px" style="font-size: 12px; color: #333333; padding-right: 5px; direction: rtl;">أدخل ما تشاهده بالصورة المجاورة<span style="color: #F00;">*</span>:</td>
							</tr>
							...
							<tr>
								<td style="width: 50%" valign="top" colspan="3" >
									<div>
										<h4 align="left" style=" display: inline-block; width: 51%; ">
											Choose one way to send the link
											<br>
											<span style=" color: #005a82; ">(The information entered must match the one we have on your personal profile)</span>
										</h4>

										<h4 align="right" style=" display: inline-block; width: 47%; direction: rtl;">
											اختر طريقة واحدة لإرسال الرابط
											<br>
											<span style=" color: #005a82; ">(يجب أن تتوافق المعلومات المدخلة مع الموجودة لدينا على حسابك الشخصي)</span>
							...
							<tr id="mbl_tr" onClick="mbl_label_click()">
								<td width="30%" height="30px" style="font-size: 12px; color: #333333; padding-left: 5px;">Syrian Mobile Number:</td>
								<td width="40%" align="center" class="tdpadding">
									<input id="mbl" title="رقم الجوال" type="text" class="notnull input_style" onKeypress="return isNumeric(event);" />
								</td>
								<td width="30%" height="40px" style="font-size: 12px; color: #333333; padding-right: 5px; direction: rtl;">
									<input type="radio" name="validation_type" id="mbl_radio" value="Mobile">
									رقم الجوال السوري:
								</td>
							</tr>
							<tr>
							...
							<tr id="email_tr" onClick="email_label_click()">
								<td width="30%" height="30px" style="font-size: 12px; color: #333333; padding-left: 5px;">Personal Email <br> (Not a University Email):</td>
								<td width="40%" align="center" class="tdpadding">
									<input id="email" type="text" class="notnull input_style" onKeypress="return valid_mail(event);" />

								</td>
								<td width="30%" height="40px" style="font-size: 12px; color: #333333; padding-right: 5px; direction: rtl;">
									<input type="radio" name="validation_type" id="email_radio" value="Email" >
									البريد الالكتروني الشخصي
									<br>
									<span style="margin-right: 25px">(ليس ايميل الجامعة):</span>
							...
							<tr>
								<td colspan="3" height="30px" align="center">
									...
									<br>
									<br>
									<input id="b1"  type="submit" value="Send Link" class="submit_btn2"/>
								</td>
							</tr>
						</table>
					</form>

					<div><img src="images/space.gif" width="0" height="4" /></div>
					<table cellspacing="0" cellpadding="0" width="100%" border="0">
						<tr>
							<td background="images/dotted_pixel_horizontal.gif" height="6">
								<div align="right"><img height="14" src="images/dotted_pixel_horizontal.gif" width="3"/>
								</div>
							</td>
						</tr>
					</table>
		...
		<script type="text/javascript">
			function mbl_label_click(){
				$('#mbl_tr').addClass( "bgcolor_2_mofadalah" );
				$('#mbl_radio').prop('checked', true );
				$('#mbl').prop('disabled', false);

				$('#email_tr').removeClass( "bgcolor_2_mofadalah" );
				$('#email_radio').prop('checked', false );
				$('#email').prop('disabled', true).val('');

				$('#b1').val('Send Link To Mobile')
			}
			function email_label_click(){
				$('#mbl_tr').removeClass( "bgcolor_2_mofadalah" );
				$('#mbl_radio').prop('checked', false );
				$('#mbl').prop('disabled', true).val('');

				$('#email_tr').addClass( "bgcolor_2_mofadalah" );
				$('#email_radio').prop('checked', true );
				$('#email').prop('disabled', false);

				$('#b1').val('Send Link To Email')
			}
			...
			function Step1(){
				...
				var validation_type=$('input[name="validation_type"]:checked').val();

				var AjaxData =  {
					user_name:user_name ,email:email ,mbl:mbl ,sid:sid ,securityImage:securityImage,user_otp:user_otp ,validation_type:validation_type
							};

				$.ajax({
				   type: "POST",
				   cache:false,
				   url: "reset_password_validation.php?action=vs1",
				   data: AjaxData ,
					beforeSend: function(){
						$('#b1').val('Sending...').prop("disabled", true);
						
					},
					complete:function(data){
						setTimeout(function () {
							$('#b1').val('Send again').prop("disabled", false);
						}, 1000);
					},
				   success: function(jRes){   
					   res=JSON.parse(jRes);
					   if(res.status=='true'){
						   var res_successful = '<tr>'+'<td valign="top" colspan="2">'+'<br><br>'+'</td>'+'</tr>'+'  '+'<tr>'+'<td style="width: 50%"><h4 align="center" style=" color: #339900; font-size: 14px; margin-bottom: 30px;">'+res.msg.en+'</h4></td>'+'</tr>'+'<tr>'+'<td style="width: 50%"><h4 align="center" style=" color: #339900;font-size: 14px; margin-bottom: 30px; ">'+res.msg.ar+'</h4></td>'+'</tr>'+'   '+'<tr>'+'<td valign="top" colspan="2">'+'<br><br>'+'</td>'+'</tr>';
						   $('#rsTabelForm').html(res_successful);
					   }else{
						   $('#secImageURL').attr('src','CaptchaSecurityImages.php?'+ new Date().getTime() );
						   $('#securityImage').val('');
						   
						   // style=" color: crimson; "
						   var res_error = '<td colspan="3" ><h4 align="center" style=" color: crimson; display: inline-block; width: 49%;  font-size: 14px; margin-bottom: 30px; ">'+res.msg.en+'</h4><h4 align="center" style=" color: crimson; display: inline-block; width: 49%; font-size: 14px; margin-bottom: 30px; ">'+res.msg.ar+'</h4></td>';
						   $('#Response1').html(res_error);
					   }
					   scrollToTop();
					}
				});
...
<font style='font-size:11px' color=red><center>page in 0.00084614753723145 seconds</center></font></body>
